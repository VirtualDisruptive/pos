...
<body id="page-top">
    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
            ...
            <!-- Sidebar - Brand -->
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="http://localhost/pos/public/">
            ...
            <div class="sidebar-card d-none d-lg-flex">
                <img class="sidebar-card-illustration mb-2" src="<?php echo base_url('img/undraw_rocket.svg'); ?>" />
                <p class="text-center mb-2"><strong>Hecha por virtual Disruptive, lideres en Sofware y marekting digital en Barcelona</p>
                <a class="btn btn-success btn-sm" href="<?php echo base_url(); ?>https://startbootstrap.com/theme/sb-admin-pro">Contactanos</a>
            </div>
                        ...
                        <li class="nav-item dropdown no-arrow mx-1">
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="alertsDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    ...
                                    <div>
                                        <div class="small text-gray-500">Septembre 7, 2022</div>
                            ...
                            <div class="dropdown-list dropdown-menu dropdown-menu-right shadow animated--grow-in" aria-labelledby="messagesDropdown">
                                ...
                                <a class="dropdown-item d-flex align-items-center" href="#">
                                    <div class="dropdown-list-image mr-3">
                                        ...
                                        <img class="img-profile rounded-circle" src="<?php echo base_url('https://source.unsplash.com/Mv9hjnEUHR4/60x60'); ?>">
